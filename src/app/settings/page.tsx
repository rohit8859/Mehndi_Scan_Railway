            ...
            <form onSubmit={handleSaveSettings} className="col-span-1 lg:col-span-2 space-y-6">
              ...
              <div className="bg-zinc-950/20 border border-zinc-850 p-6 rounded-3xl space-y-4">
                <h3 className="font-serif font-bold text-sm text-zinc-200 flex items-center gap-2">
                  ...
                  <span>Vision AI Model Settings</span>
                </h3>
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-1.5">Active AI Vision Model</label>
                    <select
                      value={activeAIModel}
                      onChange={(e) => setActiveAIModel(e.target.value)}
                      className="w-full bg-zinc-900 border border-zinc-800 focus:border-amber-500/50 rounded-xl py-2 px-3 text-xs focus:outline-none text-white transition-all"
                    >
                      <option value="gpt-4o-mini">OpenAI GPT-4o Mini (Recommended, Fast & Cost-efficient)</option>
                      <option value="gpt-4o">OpenAI GPT-4o (High Detail Analysis)</option>
                      <option value="gemini-1.5-flash">Google Gemini 1.5 Flash (Ultra Fast)</option>
                      <option value="meta-llama/llama-4-scout-17b-16e-instruct">Groq Llama 4 Scout Vision (Super Fast & Powerful)</option>
                      <option value="qwen/qwen3.6-27b">Groq Qwen 3.6 Vision (High Detail)</option>
                    </select>
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-1.5">OpenAI API Key</label>
                    <input
                      type="password"
                      placeholder="sk-..."
                      value={openaiApiKey}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-1.5">Google AI Studio API Key</label>
                    <input
                      type="password"
                      placeholder="AIzaSy..."
                      value={geminiApiKey}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-1.5">Groq API Key</label>
                    <input
                      type="password"
                      placeholder="gsk_..."
                      value={groqApiKey}
              ...
              <div className="bg-zinc-950/20 border border-zinc-850 p-6 rounded-3xl space-y-4">
                <h3 className="font-serif font-bold text-sm text-zinc-200 flex items-center gap-2">
                  ...
                  <span>Automatic Review Constraints</span>
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                  <label className="flex items-center gap-3 p-3 bg-zinc-900/40 rounded-2xl border border-zinc-850 cursor-pointer select-none">
                    <input
                      type="checkbox"
                      checked={autoApproveEnabled}
                      onChange={(e) => setAutoApproveEnabled(e.target.checked)}
                      className="accent-amber-500 rounded border-zinc-850 w-4 h-4"
                    />
                    <div>
                      <span className="text-xs font-semibold text-zinc-200 block">Enable Auto-Approval</span>
                      <span className="text-[10px] text-zinc-500 block">Auto-approves highly confident scans without manual queue</span>
                    </div>
                  </label>
                  ...
                  {autoApproveEnabled && (
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setAutoApproveThreshold(parseInt(e.target.value) || 95)}
                        className="w-full bg-zinc-900 border border-zinc-800 focus:border-amber-500/50 rounded-xl py-2 px-3 text-xs focus:outline-none text-white transition-all"
                      />
                    </div>
                  )}
